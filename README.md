...
SecondSection1:addButton("aposterqc#0540 - scripter", function() setclipboard("aposterqc#0540") jailbreakNotify("Copied to clipboard.") end)
SecondSection1:addButton("aposterqc#0540 - ui library", function() setclipboard("aposterqc#0540") jailbreakNotify("Copied to clipboard.") end)
SecondSection1:addButton("Youtube:")
SecondSection1:addButton("-", function() setclipboard("-") jailbreakNotify("Copied to clipboard.") end)
